...
function find_dual_solution(model::SDP_Model, target_val::Float64 = Inf, iterations::Int64 = 5000; verbose = true, kwargs...)
	...
	if(haskey(kwargs, :x_0))	
		COSMO.warm_start_primal!(real_model, kwargs[:x_0])
	end
	
	if(haskey(kwargs, :y_0))	
		COSMO.warm_start_dual!(real_model, kwargs[:y_0])
	end
